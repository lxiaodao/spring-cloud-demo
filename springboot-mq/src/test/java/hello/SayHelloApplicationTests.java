...
import com.ecrm.mq.SpringbootMqApplication;

@RunWith(SpringRunner.class)
@SpringBootTest(classes = SpringbootMqApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
